...
use SeGuiMo\CRMBundle\Entity\Cuentas;
use SeGuiMo\CRMBundle\Form\CuentasType;
...
class CuentasController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('SeGuiMoCRMBundle:Cuentas')->findAll();
     ...
     *
     * @Route("/", name="cuentas_create")
     * @Method("POST")
     * @Template("SeGuiMoCRMBundle:Cuentas:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('SeGuiMoCRMBundle:Cuentas')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="cuentas_update")
     * @Method("PUT")
     * @Template("SeGuiMoCRMBundle:Cuentas:edit.html.twig")
     */
